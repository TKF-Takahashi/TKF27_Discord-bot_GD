...
<div class="form-group">
    ...
    <input type="text" name="channel_id" class="form-control" value="<?php echo html_escape($channel_id); ?>">
    <small class="text-muted">Botが募集を投稿するDiscordチャンネルのIDを入力してください。</small>
</div>
